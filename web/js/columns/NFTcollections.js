...
Q.exports(function (options, index, column, data) {
    Q.addStylesheet('{{Communities}}/css/columns/NFTcollections.css', {slotName: 'Communities'});
        ...
        column.forEachTool("Assets/NFT/collection/preview", function () {
            ...
            this.state.onInvoke.set(function () {
                ...
                columnsTool.push({
                    ...
                    template: 'Communities/NFT/collection/column',
                    fields: {
                    ...
                    $(".Communities_NFT_collection", column).tool("Streams/preview", {
                    ...
                    var $collectionRelation = $(".Communities_NFT_collection_relation", column);
                    ...
                    $collectionRelation[0].forEachTool("Assets/NFT/series/preview",function () {
                        ...
                        this.state.onInvoke.set(function (seriesStream) {
                            ...
                            Q.handle(Q.url(["Communities", "NFTprofile", publisherId].join("/") + "?selectedSeriesId=" + streamName.split("/").pop()));
                        }, this);
                    }, true);
                    ...
                    $("button[name=enter]", column).on(Q.Pointer.fastclick, function () {
                        ...
                        Q.Dialogs.push({
                            title: "Select series",
                            className: "Communities_NFT_collection_series",
                            ...
                            onActivate: function (dialog) {
                                dialog.forEachTool("Assets/NFT/series/preview", function () {
                                    this.state.onInvoke.set(function (seriesStream) {
...
Q.Template.set('Communities/NFT/collection/column',
    `<div class="Communities_NFT_collection"></div>
        <div class="Communities_NFT_collection_relation"></div>
        {{#if userId}}
