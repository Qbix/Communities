...
Please read these Terms of Service ("Terms", "Terms of Service") carefully before using the <?php echo Q::text($communityName) ?> website or mobile application (together, or individually, the "Service") operated by <?php echo Q_Html::text($organizationName) ?> ("us", "we", or "our").
...
<p><?php echo Q_Html::text($organizationName) ?> has the right but not the obligation to monitor and edit all Content provided by users.</p>

<p>In addition, Content found on or through this Service are the property of <?php echo Q_Html::text($organizationName) ?> or used with permission. You may not distribute, modify, transmit, reuse, download, repost, copy, or use said Content, whether in whole or in part, for commercial purposes or for personal gain, without express advance written permission from us.</p>
...
<p>If you are a copyright owner, or authorized on behalf of one, and you believe that the copyrighted work has been copied in a way that constitutes copyright infringement, please submit your claim via email to <?php echo Q_Html::text($dmcaEmail) ?>, with the subject line: "Copyright Infringement" and include in your claim a detailed description of the alleged Infringement as detailed below, under "DMCA Notice and Procedure for Copyright Infringement Claims"</p>
...
<p>You can contact our Copyright Agent via email at <?php echo Q_Html::text($dmcaEmail) ?></p>
...
<p>Our Service may contain links to third party web sites or services that are not owned or controlled by <?php echo Q_Html::text($organizationName) ?></p>

<p><?php echo Q_Html::text($organizationName) ?> has no control over, and assumes no responsibility for the content, privacy policies, or practices of any third party web sites or services. We do not warrant the offerings of any of these entities/individuals or their websites.</p>

<p>You acknowledge and agree that <?php echo Q_Html::text($organizationName) ?> shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with use of or reliance on any such content, goods or services available on or through any such third party web sites or services.</p>
...
<p><?php echo Q_Html::text($organizationName) ?> its subsidiaries, affiliates, and its licensors do not warrant that a) the Service will function uninterrupted, secure or available at any particular time or location; b) any errors or defects will be corrected; c) the Service is free of viruses or other harmful components; or d) the results of using the Service will meet your requirements.</p>
...
<p>These Terms shall be governed and construed in accordance with the laws of <?php echo Q_Html::text($jurisdiction) ?>, without regard to its conflict of law provisions.</p>
